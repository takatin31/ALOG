...
$(function () { 
    ...
    var url = 'http://ca249c44.ngrok.io/appointments';
    $.ajax({
        url: url,
        ...
        beforeSend: function (xhr) {
          xhr.setRequestHeader ("Authorization", "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlcyI6WyJjdXN0b21lciJdLCJpYXQiOjE1ODczMTA2NTIsImV4cCI6MTU4NzMxNDI1Miwic3ViIjoiNWU5MWRjZDU1YjY1ZGI3Nzk3NGU0ZThlIn0.OnluKGnToaXO0w4zv33_z0M4MvqgtXqozpVWliPurGo");
        },
        type: 'GET',
    });
    ...
    var timeList = localStorage.getItem("tbAppointment");
        ...
        for (let i = 0; i < timeList.length; i++) {
            ...
            if (element.date == $("#date").val()) {
                $("#appointment_day > tbody").append(
                        `
                        <tr>
                            <td class="text-center align-middle">${element.patient}</td>
